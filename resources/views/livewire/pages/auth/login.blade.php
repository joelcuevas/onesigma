    ...
    <form wire:submit="login">
        ...
        <div class="mt-4 flex items-center justify-end">
            @if (Route::has('password.request'))
                <a class="rounded-md text-sm text-gray-600 underline hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" href="{{ route('password.request') }}" wire:navigate>
            ...
            <x-link-button :href="route('github.login')" class="ms-3">
                {{ __('Github Login') }}
            </x-link-button>
        </div>
    </form>
